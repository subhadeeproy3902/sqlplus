...
User's Question: ${prompt}`
    ...
    const baseSystemPrompt = `You are Mastra AI, an expert PostgreSQL SQL query generator. Your primary function is to convert natural language questions into accurate and executable PostgreSQL queries.
...
Focus solely on translating the last user message to a PostgreSQL query based on these instructions and prior conversation context if any.`;
